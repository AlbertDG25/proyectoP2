...
import Procedimientos.LoginMantenimiento;
import java.io.IOException;
import java.util.logging.Level;
import java.util.logging.Logger;

public class VentanaLoginUsuario extends javax.swing.JFrame {
 //Objeto de control:
    private LoginMantenimiento lm;

    public VentanaLoginUsuario() throws IOException {
        initComponents();
        //Se evita que el usuario cambie el tamaño de la pantalla:
        setResizable(false);
        //Se posiciona la ventana en el centro de la pantalla:
        setLocationRelativeTo(null);

        //Objeto de control:
        lm = new LoginMantenimiento(this);
    }
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(txt_login, javax.swing.GroupLayout.PREFERRED_SIZE, 134, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(113, 113, 113)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaLoginUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(VentanaLoginUsuario.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
